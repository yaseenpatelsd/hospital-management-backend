...
public class DoctorController {
    ...
    public DoctorController(GlobalRegisterFlow globalRegisterFlow) {
        this.globalRegisterFlow = globalRegisterFlow;
    }

    @PostMapping("/register")
    public ResponseEntity<?> registerUser(@Valid @RequestBody GlobalRegisterDto dto){
        globalRegisterFlow.doctorRegister(dto);
        return ResponseEntity.ok("doctor is register please verify account with otp sand to your email");
    }
    ...
    public ResponseEntity<?> accountVerification(@Valid @RequestBody GlobalAccountVerification dto){
        ...
        return ResponseEntity.ok("doctor account is verified");
    }
    ...
    public ResponseEntity<?> passwordReset(@Valid @RequestBody GlobalPasswordResetDto dto){
        ...
        return ResponseEntity.ok("Password is reset you can log in usimg it");
    }
}
